...
public class RequestRemittanceCommand extends SelfValidating<RequestRemittanceCommand> {
    ...
    private final Integer remittanceType; // 0: membership(내부 고객), 1: bank (외부 은행 계좌)
    ...
    @Builder
    public RequestRemittanceCommand(String fromMembershipId, String toMembershipId, String toBankName, String toBankAccountNumber, Integer remittanceType, Integer amount) {
